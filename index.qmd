...
author: "Rachel Buxton, course developed by Roz Dakin"
hidedate: true
format: html
editor: visual
toc: true
...
+-------------------------------+------------------------+
| Professor: Dr. Rachel Buxton  | Office: Hertzberg 4438 |
+-------------------------------+------------------------+
| Fridays, 8:35 - 11:25\        | Southam Hall 415       |
...
-   [Assignment 1 due January 18, 2026](assignment%201.html)

-   [Assignment 2 due February 1, 2026](assignment_2.html)

-   [Assignment 3 due February 15, 2026](assignment_3.html)

-   [Assignment 4 due March 1, 2026](assignment_4.html)

-   [Assignment 5 due March 15, 2026](assignment_5.html)

-   [Assignment 6 due March 29, 2026](assignment_6.html)
...
+======+==================+=============================+=========================================+
| 1    | Jan 9            | Intro, philosopy, tidy data | -   Install R and R Studio              |
|      |                  |                             | -   Read Roche et al.                   |
|      |                  |                             | -   Read Alston & Rick                  |
|      |                  |                             | -   Irizarry Section 1                  |
|      |                  |                             | -   r4ds Introduction                   |
+------+------------------+-----------------------------+-----------------------------------------+
| 2    | Jan 16           | R basics                    | -   Irizarry Section 2                  |
|      |                  |                             | -   r4ds Section 2                      |
|      |                  |                             | -   [**Assignment #1**]{.smallcaps}     |
+------+------------------+-----------------------------+-----------------------------------------+
| 3    | Jan 23           | Programming basics          | -   Read Noble 2009                     |
|      |                  |                             | -   Irizarry Sections 3 & 6             |
|      |                  |                             | -   r4ds Section 6                      |
|      |                  |                             | -   Extra: r4ds Section 27              |
+------+------------------+-----------------------------+-----------------------------------------+
| 4    | Jan 30           | tidyverse & data            | -   Irizarry Section 4                  |
|      |                  |                             | -   [**Assignment #2**]{.smallcaps}     |
+------+------------------+-----------------------------+-----------------------------------------+
| 5    | Feb 6            | tidyverse & data            | -   Irizarry Sections 11-12             |
|      |                  |                             | -   Read Broman & Woo                   |
+------+------------------+-----------------------------+-----------------------------------------+
| 6    | Feb 13           | Visualization, part 1       | -   Irizarry Sections 7-8               |
...
+------+------------------+-----------------------------+-----------------------------------------+
| 8    | Feb 27           | Visualization, part 2       | -   Irizarry Sections 9-10              |
